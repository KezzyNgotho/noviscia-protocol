...
**Last updated:** 2026-09-06T18:44:12.253Z
...
| 4 | Atomic Reversion Control | 🟢 Proven On Paper / Code | $0 Capital Leakage on failed transactions | scripts/devnet/measure-atomicity.ts | All 3 core programs live (netting-engine, nv-usdc-vault, noviscia-capacity EDBr2VFW) — integration test not yet run |
...
| 7 | Time-Accelerated Timeout Locks | 🟡 Simulated / Sandbox | 60s Expiry Execution (1440x scale) | devnet-window-observation.json + scripts/devnet/observe-capacity-window-devnet.ts | window_start_slot=494190470 observed_slot=494198176 posture=Open mature=494406470 (~24h) breach=494424470 (~26h) |
...
**Summary:** 0/6 probe targets flipped to testnet-measured. Counterparty and legal claims remain pending.
