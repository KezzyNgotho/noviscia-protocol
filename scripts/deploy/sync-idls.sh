...
mkdir -p "$WEB"
for f in escrow position_tracker burn_engine staking_manager nv_usdc_vault yield_distributor liquidation_vault bug_bounty noviscia_clearing token_nvsc protocol_lp_vault netting_engine yield_router; do
