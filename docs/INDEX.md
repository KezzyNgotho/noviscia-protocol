...
| [`devnet-findings.md`](devnet-findings.md) | — | Verified 2026-09-06 | Real devnet ground truth: compiled `.so` inventory, 10/11 deploy-map IDs live, `noviscia-capacity` absent + keypair mismatch — measured, not simulated |
