...
#   app/web/lib/data/chaos-summary.json       — radar-surfaced baseline (private-repo app)
```
...
concrete, reproducible command. Nothing in this file requires a closed layer: the private
alpha repo (searcher, venues, bot configs) is separate and described in
`docs/CODE_ACCESSIBILITY_MATRIX.md`, and this proof stands independently of it.
